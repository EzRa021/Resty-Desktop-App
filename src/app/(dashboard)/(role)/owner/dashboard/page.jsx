    ...
    <>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold tracking-tight">Welcome back, {user?.name || "Owner"}</h1>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">$124,231.89</div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
          ...
          <Card className="col-span-3">
            ...
            <CardContent>
              <div className="h-[300px] rounded-md border border-dashed flex items-center justify-center">
                <p className="text-sm text-muted-foreground">Branch comparison chart will appear here</p>
              </div>
            </CardContent>
          </Card>
        </div>
